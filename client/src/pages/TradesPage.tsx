    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      ...
      <section className="pt-36 pb-20 bg-[#0D0D0D] relative overflow-hidden">
        ...
        <div className="container max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-orange-500 text-xs font-bold tracking-widest uppercase mb-4">Trades We Serve</div>
          <h1 className="font-display text-5xl md:text-7xl font-black uppercase leading-none mb-6">
            AI Marketing for <span className="text-orange-500">Every Trade</span>
          </h1>
          <p className="text-gray-400 text-xl max-w-3xl leading-relaxed mb-10">
            Contractor5x is built for local trade businesses. Whether you're a plumber, roofer, landscaper, or HVAC tech — we have a marketing system tailored specifically to how your business works and what your customers need to see before they call.
          </p>
          <Link href="/#contact">
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-8 py-4 text-base rounded-sm uppercase tracking-wide">
              Get Started for Your Trade <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
          </Link>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#0D0D0D] border-t border-white/10">
        <div className="container max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-4xl md:text-5xl font-black uppercase mb-4">
            Don't See Your Trade? <span className="text-orange-500">We Still Got You.</span>
          </h2>
          <p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
            We work with all local service businesses. If you do skilled work in people's homes or businesses, our AI marketing system will work for you.
          </p>
          <Link href="/#contact">
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-10 py-4 text-base rounded-sm uppercase tracking-wide">
              Talk to Us About Your Trade <ArrowRight className="ml-2 w-4 h-4" />
            </Button>
          </Link>
        </div>
      </section>
