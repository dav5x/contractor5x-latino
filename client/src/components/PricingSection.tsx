...
const plans = [
  {
    ...
    price: "199",
    period: "/mo",
    tagline: "Get your digital foundation in place",
    features: [
  ...
  },
  {
    ...
    price: "299",
    period: "/mo",
    tagline: "Start capturing and closing more leads",
    features: [
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                  <span
                    className="flex items-center gap-1.5 bg-[#F97316] text-black text-xs font-semibold px-4 py-1.5 rounded-sm whitespace-nowrap"
              ...
              <div className="mb-5">
                ...
                <p className="text-white/50 text-sm leading-snug" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                  {plan.tagline}
                </p>
              </div>
